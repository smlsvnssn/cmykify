...
var app = (function () {
    ...
    const file$2 = "src/CMYKify.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			span7 = element("span");
    			span7.textContent = "K";
    			t13 = text("ificators® to adjust\n\t\tthe colour to your specific needs, and copy/paste the resulting mixin into your scss. It's that easy!");
    			attr_dev(span0, "class", "c svelte-1ve77s6");
    			add_location(span0, file$2, 6, 5, 168);
    			attr_dev(span1, "class", "m svelte-1ve77s6");
    			add_location(span1, file$2, 6, 29, 192);
    			attr_dev(span2, "class", "y svelte-1ve77s6");
    			add_location(span2, file$2, 6, 53, 216);
    			attr_dev(span3, "class", "k svelte-1ve77s6");
    			add_location(span3, file$2, 6, 77, 240);
    			add_location(h1, file$2, 6, 1, 164);
    			add_location(p0, file$2, 7, 1, 275);
    			attr_dev(span4, "class", "c svelte-1ve77s6");
    			add_location(span4, file$2, 9, 26, 347);
    			attr_dev(span5, "class", "m svelte-1ve77s6");
    			add_location(span5, file$2, 9, 50, 371);
    			attr_dev(span6, "class", "y svelte-1ve77s6");
    			add_location(span6, file$2, 9, 74, 395);
    			attr_dev(span7, "class", "k svelte-1ve77s6");
    			add_location(span7, file$2, 9, 98, 419);
    			add_location(p1, file$2, 8, 1, 317);
    			attr_dev(div, "class", "cmykify svelte-1ve77s6");
    			toggle_class(div, "visible", /*visible*/ ctx[0]);
    			add_location(div, file$2, 5, 0, 84);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (clickOutside_action && is_function(clickOutside_action.update) && dirty & /*visible*/ 1) clickOutside_action.update.call(null, /*clickOutside_function*/ ctx[1]);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	const clickOutside_function = () => $$invalidate(0, visible = false);
    	$$self.$capture_state = () => ({ clickOutside, visible });
    	...
    	return [visible, clickOutside_function];
    }
    ...
    function create_if_block(ctx) {
    	...
    	function slider4_value_binding(value) {
    		/*slider4_value_binding*/ ctx[13](value);
    	}
    	...
    	function slider5_value_binding(value) {
    		/*slider5_value_binding*/ ctx[14](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			pre = element("pre");
    			t6 = text(/*mixin*/ ctx[5]);
    			attr_dev(form, "class", "svelte-htqw88");
    			add_location(form, file, 53, 4, 1908);
    			attr_dev(div0, "class", "settings svelte-htqw88");
    			add_location(div0, file, 52, 3, 1841);
    			add_location(pre, file, 63, 4, 2543);
    			attr_dev(div1, "class", "cmykOut svelte-htqw88");
    			attr_dev(div1, "contenteditable", "true");
    			attr_dev(div1, "spellcheck", "false");
    			add_location(div1, file, 62, 3, 2436);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty & /*mixin*/ 32) set_data_dev(t6, /*mixin*/ ctx[5]);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "cmyk svelte-htqw88");
    			add_location(div0, file, 45, 1, 1563);
    			attr_dev(span0, "class", "c svelte-htqw88");
    			add_location(span0, file, 48, 3, 1722);
    			attr_dev(span1, "class", "m svelte-htqw88");
    			add_location(span1, file, 48, 27, 1746);
    			attr_dev(span2, "class", "y svelte-htqw88");
    			add_location(span2, file, 48, 51, 1770);
    			attr_dev(div1, "class", "header svelte-htqw88");
    			add_location(div1, file, 47, 2, 1624);
    			add_location(br, file, 50, 2, 1816);
    			attr_dev(div2, "class", "cmykIt svelte-htqw88");
    			add_location(div2, file, 46, 1, 1601);
    			attr_dev(div3, "class", "cmykificator svelte-htqw88");
    			add_location(div3, file, 44, 0, 1535);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					action_destroyer(css_action = css.call(null, div0, /*props*/ ctx[3])),
    					listen_dev(div1, "click", /*click_handler*/ ctx[7], false, false, false),
    					listen_dev(div1, "mouseenter", /*mouseenter_handler*/ ctx[8], false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (css_action && is_function(css_action.update) && dirty & /*props*/ 8) css_action.update.call(null, /*props*/ ctx[3]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let props, active = false, settingsEl, cmykoutEl, outsideListener;
    	...
    	const click_handler = () => $$invalidate(4, active = !active);
    	const mouseenter_handler = () => $$invalidate(4, active = true);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('settingsEl' in $$props) $$invalidate(1, settingsEl = $$props.settingsEl);
    		if ('cmykoutEl' in $$props) $$invalidate(2, cmykoutEl = $$props.cmykoutEl);
    		if ('outsideListener' in $$props) $$invalidate(6, outsideListener = $$props.outsideListener);
    		if ('mixin' in $$props) $$invalidate(5, mixin = $$props.mixin);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*settingsEl, cmykoutEl, outsideListener*/ 70) {
    		...
    		if ($$self.$$.dirty & /*settings*/ 1) {
    			$$invalidate(5, mixin = `@mixin cmykify($c: 20, $m: 40, $y: 100, $k: 10, $raster: 3, $saturation: 1) {
