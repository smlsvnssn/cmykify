    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(form, "class", "svelte-1do37xh");
    			add_location(form, file, 30, 4, 1050);
    			attr_dev(div, "class", "settings svelte-1do37xh");
    			add_location(div, file, 29, 3, 1006);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, form);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "cmyk svelte-1do37xh");
    			add_location(div0, file, 23, 1, 695);
    			attr_dev(span0, "class", "c svelte-1do37xh");
    			add_location(span0, file, 26, 3, 896);
    			attr_dev(span1, "class", "m svelte-1do37xh");
    			add_location(span1, file, 26, 27, 920);
    			attr_dev(span2, "class", "y svelte-1do37xh");
    			add_location(span2, file, 26, 51, 944);
    			attr_dev(div1, "class", "header svelte-1do37xh");
    			add_location(div1, file, 25, 2, 798);
    			attr_dev(div2, "class", "cmykIt svelte-1do37xh");
    			add_location(div2, file, 24, 1, 733);
    			attr_dev(div3, "class", "cmykificator svelte-1do37xh");
    			add_location(div3, file, 22, 0, 667);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
