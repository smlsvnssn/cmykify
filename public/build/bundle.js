    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input1, file$1, 14, 1, 322);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(form, "class", "svelte-qeim7m");
    			add_location(form, file, 31, 4, 1460);
    			attr_dev(div, "class", "settings svelte-qeim7m");
    			add_location(div, file, 30, 3, 1416);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, form);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(span0, "class", "c svelte-qeim7m");
    			add_location(span0, file, 27, 3, 1306);
    			attr_dev(span1, "class", "m svelte-qeim7m");
    			add_location(span1, file, 27, 27, 1330);
    			attr_dev(span2, "class", "y svelte-qeim7m");
    			add_location(span2, file, 27, 51, 1354);
    			attr_dev(div0, "class", "header svelte-qeim7m");
    			add_location(div0, file, 26, 2, 1208);
    			attr_dev(div1, "class", "cmykIt svelte-qeim7m");
    			add_location(div1, file, 25, 1, 1143);
    			attr_dev(div2, "class", "cmyk svelte-qeim7m");
    			add_location(div2, file, 24, 0, 1107);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
